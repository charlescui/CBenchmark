 ...
 */
const char *NAME = "SASL plugin PLAIN - Ver. 1.0";
...
int plg_authenticate (smtp_srv_t * srv)
{
    ...
    cred = (char*)malloc_ (len);
    enc  = (char*)malloc_ (2*len+4);
